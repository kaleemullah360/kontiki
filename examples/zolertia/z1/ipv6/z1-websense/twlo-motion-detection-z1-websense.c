...
// --------  End Motion Detection: declare variables  ----------------
...
// --------  Motion Detection: Prediction function definition  ----------------
void predict(){
...
//    }
  ...
  if(result4<result1 && result4<result2 && result4<result3){last=*STATUS_PT;STATUS_PT=FALLING;if(last!=*STATUS_PT)printf("falling\n");}
} // end Predict()
// --------  End Motion Detection: Prediction function definition  ----------------
...
// --------  Motion Detection: Initialized and Execution  ----------------
...
// --------  End Motion Detection: Initialized and Execution  ----------------
          }
          PROCESS_END();
        }
