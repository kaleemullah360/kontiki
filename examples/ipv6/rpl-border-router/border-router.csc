...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <description>Border-Router-Z1</description>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>0.9090909090909091 0.0 0.0 0.9090909090909091 383.0 206.0</viewport>
    </plugin_config>
    <width>980</width>
    <z>2</z>
    <height>467</height>
  ...
  <plugin>
    ...
    <plugin_config>
      <notes>Border-Router ID 1
Server Started listening at port 60001
connect: make connect-router-cooja</notes>
